<?php	
	...
	// $location="/modelcarsystem/model_form.html.php?";
	$location="/modelcarsystem/model_form.html.php? status=CM_UPDATE& productCode={$model['productCode']}& productName={$model['productName']}& productLine={$model['productLine']}& productScale={$model['productScale']}& productVendor={$model['productVendor']}& productDescription={$model['productDescription']}& quantityInStock={$model['quantityInStock']}& buyPrice={$model['buyPrice']}& sellingPrice={$model['sellingPrice']}";
